      ...
      <AnimatePresence>
        {flashAlert && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            ⚠ {flashAlert.title} — T+{Math.round(flashAlert.timestamp)}s
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="live-main">
        <div className="live-col">
          <div className="live-panel live-simulate-panel live-simulate-primary">
            <span className="live-panel-title mono">🎮 SIMULATE LIVE TELEMETRY</span>
            <p className="live-simulate-note">
          ...
          <div className="live-panel live-manual-panel">
            <span className="live-panel-title mono">🕹 MANUAL PACKET CONTROL — PILOT IT YOURSELF</span>
            <p className="live-simulate-note">
