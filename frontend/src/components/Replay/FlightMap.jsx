...
function droneIcon(heading, pulsing) {
  return L.divIcon({
    ...
    html: `<div class="drone-marker${pulsing ? ' drone-marker-pulse' : ''}" style="transform: rotate(${heading}deg)">
             <svg viewBox="0 0 24 24" width="26" height="26"><path d="M12 2 L19.5 20 L12 16 L4.5 20 Z" fill="#a855f7" stroke="#0a0a0c" stroke-width="1"/></svg>
           </div>`,
    iconSize: [26, 26],
    iconAnchor: [13, 13],
  });
  ...
  return (
    <div className="flight-map">
      ...
      >
        ...
        <Polyline positions={path} pathOptions={{ color: '#a855f7', weight: 6, opacity: 0.12 }} />
        <Polyline positions={path} pathOptions={{ color: '#a855f7', weight: 2, opacity: 0.65 }} />
